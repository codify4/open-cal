...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar px-2 pt-2 mt-0 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent overflow-hidden",
      ...
      classNames={{
        ...
        today: cn(
          "bg-red-500/80 text-white hover:bg-red-500/70 rounded-md",
