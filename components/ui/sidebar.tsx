  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          className={cn(
            'group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-neutral-950',
            className
          )}
...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex h-full w-full flex-col rounded-lg border-none bg-neutral-950"
          data-sidebar="sidebar"
