      ...
      <SidebarMenuItem>
        <Dialog>
          <DialogTrigger asChild>
            <SidebarMenuButton
              className="cursor-pointer data-[state=open]:text-sidebar-accent-foreground text-white focus:ring-0 focus:outline-none hover:bg-transparent"
              size="lg"
            >
          ...
          <DialogContent className="h-[600px] w-[1000px] bg-neutral-950 text-white border border-neutral-800 p-0">
            <div className="flex h-full">
              <div className="w-1/4 border-neutral-800 border-r px-3 py-4">
                <div className="mb-4 rounded-lg bg-neutral-900 border border-neutral-800 p-3">
              ...
              <div className="w-3/4 overflow-y-auto p-6 text-white">
        ...
        <Card className="border-neutral-800 bg-neutral-900">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <button
                className={`cursor-pointer rounded-lg border-2 border-neutral-800 p-4 transition-all ${
                  selectedTheme === 'light'
              ...
              >
                ...
                <div className="h-8 rounded border-2 border-neutral-800 bg-neutral-900" />
              </button>
            ...
            <div className="flex items-center justify-between rounded-lg bg-neutral-800 p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">$29/month</p>
                </div>
              </div>
              <Badge
