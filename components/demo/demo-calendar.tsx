...
import WeeklyView from './demo-view/week-view';
import MonthView from './demo-view/month-view';
import DailyView from './demo-view/daily-view';
...
export default function CalendarView({
  ...
  return (
    <div className="flex w-full flex-col gap-6 p-2 text-white bg-neutral-950">
      ...
      <div className="flex w-full">
        <div className="relative w-full">
          <Tabs
            ...
            value={viewType}
          >
            <div className="sticky top-0 z-50 flex items-center justify-between border-neutral-800 border-b backdrop-blur">
              <div className="flex w-full items-center justify-between gap-4 pb-2">
                <div className="flex items-center gap-2">
                  <div className="mr-2 flex items-center gap-2">
                    <h1 className="font-semibold text-lg text-white ml-2">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className='text-white bg-neutral-800 hover:bg-neutral-700 border-neutral-700'
                    >
                ...
                <div className="flex items-center gap-2">
                  <Button
                    className="hidden h-8 w-20 rounded-sm bg-neutral-800 hover:bg-neutral-700 border-neutral-700 text-sm sm:flex"
                  ...
                  <TabsList className="grid grid-cols-3 bg-neutral-800 border-neutral-700">
                    <TabsTrigger value="day" className='text-white bg-neutral-800 data-[state=active]:bg-neutral-700 border-neutral-700'>
                      <div className="flex items-center space-x-2">
                        <CalendarDaysIcon size={15} />
                        <span>Day</span>
                      </div>
                    </TabsTrigger>
                    <TabsTrigger value="week" className='text-white bg-neutral-800 data-[state=active]:bg-neutral-700 border-neutral-700'>
                      <div className="flex items-center space-x-2">
                        <BsCalendarWeek />
                        <span>Week</span>
                      </div>
                    ...
                    <TabsTrigger value="month" className='text-white bg-neutral-800 data-[state=active]:bg-neutral-700 border-neutral-700'>
                      <div className="flex items-center space-x-2">
                        <BsCalendarMonth />
                        <span>Month</span>
                      </div>
